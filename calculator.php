...
$operation = new Operation($operand1, $operand2, $operator);
$operation->calculate();
                ...
                <form class="mt-4" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="operator" class="form-select form-select-lg rounded-3">
                            <option value="+" <?= $operation->operator == "+" ? "selected" : "" ?>>Cộng (+)</option>
                            <option value="-" <?= $operation->operator == "-" ? "selected" : "" ?>>Trừ (-)
                            </option>
                            <option value="*" <?= $operation->operator == "*" ? "selected" : "" ?>>Nhân
                                (*)
                            </option>
                            <option value="/" <?= $operation->operator == "/" ? "selected" : "" ?>>Chia (÷)</option>
                        </select>
                    </div>
